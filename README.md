...
- `823,5+ MB` **[Click here if want a modded experience (contains only HD models)](https://drive.google.com/drive/folders/1abH0B7J_guxpmqyviiPKxV3JC_6Uh-V4)**, courtesy of @GdGohan . This replaces the Musics with their original soundtracks with high quality (instead of their remixes), and also alters the way the Main Menu and the on-screen HUD looks.
...
compression level: store or normal
